...
## [impact statement]
Enabling Wireguard encryption adds overhead and reduces network throughput. If you need node-to-node encryption for only specific networks (e.g., spanning data centers) you can enable `excludeAdvertisedNetworks` for local networks that do not require encrpytion.
...
## [references]
https://docs.siderolabs.com/talos/latest/networking/kubespan
